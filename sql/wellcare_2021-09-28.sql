...
# Dump of table wellcare_questionnaire
# ************************************************************
...
CREATE TABLE `complete_check` (
	`id` BIGINT(19) NOT NULL AUTO_INCREMENT,
	`agree_id` BIGINT(19) NOT NULL DEFAULT '0',
...
CREATE TABLE `common_question` (
	`id` BIGINT(19) NOT NULL AUTO_INCREMENT,
	`agree_id` BIGINT(19) NOT NULL DEFAULT '0',
	`category_id` BIGINT(19) NOT NULL DEFAULT '0' COMMENT '1: 질환력 / 2: 흡연 / 3: 음주 / 4: 신체활동',
	`answer_text` VARCHAR(255) NOT NULL COLLATE 'utf8mb4_general_ci',
	`answer` VARCHAR(255) NOT NULL COLLATE 'utf8mb4_general_ci',
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '1',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `nutrition_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '2',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cognitive_question` (
	...
	CONSTRAINT `FK1_AGREE_COGNITIVE` FOREIGN KEY (`agree_id`) REFERENCES `questionnaire`.`agree` (`id`) ON UPDATE RESTRICT ON DELETE RESTRICT,
	CONSTRAINT `FK2_QUESTION_CATEGORY_COGNITIVE` FOREIGN KEY (`question_type_id`) REFERENCES `questionnaire`.`question_category` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION
)
COMMENT='인지기능  설문'
COLLATE='utf8mb4_general_ci'
ENGINE=InnoDB
...
CREATE TABLE `mental_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '4',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `stress_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '5',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `stomach_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '6',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sleep_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '7',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `fatigue_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '8',
	PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `samkim_question` (
	...
	`create_date` DATETIME NOT NULL DEFAULT current_timestamp(),
	`modified_date` DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
	`question_type_id` BIGINT(19) NOT NULL DEFAULT '9',
	PRIMARY KEY (`id`) USING BTREE,
