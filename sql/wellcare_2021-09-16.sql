...
CREATE TABLE `resv_consultation_limit` (
	`id` BIGINT(19) NOT NULL AUTO_INCREMENT,
	`hour` VARCHAR(255) NULL DEFAULT '' COLLATE 'utf8mb4_bin',
...
CREATE TABLE `clinical_trial` (
	`id` BIGINT(19) NOT NULL AUTO_INCREMENT COMMENT '문진타입id',
	`title` VARCHAR(255) NULL DEFAULT '0' COMMENT '문진제목' COLLATE 'utf8mb4_0900_ai_ci',
	`create_date` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
